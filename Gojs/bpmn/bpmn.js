var init = function () {
  ...
  let myPalette1 = $(go.Palette, 'myPaletteDiv1', {
  ...
  let myPalette2 = $(go.Palette, 'myPaletteDiv2', {
    nodeTemplateMap: palNodeTemplateMap,
    groupTemplateMap: palGroupTemplateMap,
    layout: $(go.GridLayout, {
      cellSize: new go.Size(1, 1),
  ...
  let myPalette3 = $(go.Palette, 'myPaletteDiv3', {
    nodeTemplateMap: palNodeTemplateMap,
    groupTemplateMap: palGroupTemplateMap,
    layout: $(go.GridLayout, {
      cellSize: new go.Size(1, 1),
  ...
  myPalette1.model = $(go.GraphLinksModel,
    {
      copiesArrays: true,
  ...
  myPalette2.model = $(go.GraphLinksModel,
    {
      copiesArrays: true,
      copiesArrayObjects: true,
      nodeDataArray: [
  ...
  myPalette3.model = $(go.GraphLinksModel,
    {
      copiesArrays: true,
      copiesArrayObjects: true,
      nodeDataArray: [
