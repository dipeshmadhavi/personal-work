...
function init() {
  ...
  const poolGroupTemplate = $(
    ...
    $(
      ...
      $(go.Placeholder, { background: 'darkgray', column: 1 })
    )
  ...
  myDiagram = $(go.Diagram, 'myDiagramDiv', {
    ...
    mouseDrop: function(e) {
      ...
      const ok = myDiagram.commandHandler.addTopLevelParts(
        myDiagram.selection,
        true
      );
  ...
  const myPaletteLevel1 = $(go.Palette, 'myPaletteLevel1', {
  ...
  const myPaletteLevel2 = $(go.Palette, 'myPaletteLevel2', {
    nodeTemplateMap: palNodeTemplateMap,
    groupTemplateMap: palGroupTemplateMap,
    layout: $(go.GridLayout, {
      cellSize: new go.Size(1, 1),
  ...
  const myPaletteLevel3 = $(go.Palette, 'myPaletteLevel3', {
    nodeTemplateMap: palNodeTemplateMap,
    groupTemplateMap: palGroupTemplateMap,
    layout: $(go.GridLayout, {
      cellSize: new go.Size(1, 1),
...
function addActivityNodeBoundaryEvent(evType, evDim) {
  ...
  myDiagram.selection.each(function(node) {
    ...
    if (
      node.data &&
      (node.data.category === 'activity' || node.data.category === 'subprocess')
    ) {
      ...
      myDiagram.model.insertArrayItem(
